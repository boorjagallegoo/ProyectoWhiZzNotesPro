...
public class Perfil_Usuario extends AppCompatActivity {
    ...
    private void LecturaDeDatos() {
        Usuarios.child(user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    // Obetener sus datos según fueron establecidos
    ...
    /**
     * Carga una imagen de perfil desde una URL y la muestra en un ImageView utilizando Glide.
     *
     * @param imagen_perfil URL de la imagen de perfil.
     */
    private void Cargar_Imagen(String imagen_perfil) {
        try {
            /*Cuando la imagen ha sido traida existosamente desde Firebase*/
            Glide.with(getApplicationContext()).load(imagen_perfil).placeholder(R.drawable.imagen_perfil_usuario).into(Imagen_Perfil);

        } catch (Exception e) {
            /*Si la imagen no fue traida con existo*/
    ...
    private void Establecer_telefono_usuario() {
        ...
        // Muestra un cuadro de diálogo para establecer el número de teléfono del usuario
    ...
    /**
     * Abre un calendario para que el usuario seleccione su fecha de nacimiento.
     * <p>
     * Método "SeleccionarFecha()" reutilizado de Actualizar_Nota.java
     */
    private void Abrir_Calendario() {
        ...
        // Abre un DatePickerDialog para seleccionar la fecha de nacimiento del usuario
        ...
        Usuarios.child(user.getUid()).updateChildren(Datos_Actualizar)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Perfil_Usuario.this, "Actualizado correctamnete", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void ComprobarInicioSesion() {
        // Comprueba si el usuario ha iniciado sesión y carga sus datos si es así.
        if (user != null) {
            LecturaDeDatos();
        } else {
    ...
    protected void onStart() {
        // Comprueba el inicio de sesión al iniciar la actividad
