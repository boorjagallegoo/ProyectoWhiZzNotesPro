...
import com.bgallego.agenda_online.Login;
...
public class ActualizarPassUsuario extends AppCompatActivity {
                                                ...
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    ...
                                                    public void onSuccess(Void unused) {
                                                        ...
                                                        Intent intent = new Intent(ActualizarPassUsuario.this, Login.class)
                                                                .addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK) // Las actividades anteriores se eliminaran de la pila
    ...
    public boolean onSupportNavigateUp() {
        onBackPressed();  // Acción que nos permite regresar a la actividad anterior
